...
public class EatsOrderManager extends Manager<EatsOrder> implements OrderService<EatsOrder> {
	
	@Override
	public void readAll(String filename, Factory<EatsOrder> factory) {
	...
	public void sortByOrderTime(boolean flag) {
		if(flag) {
			Comparator<EatsOrder> comparator = new Comparator<EatsOrder>() {
				@Override
				public int compare(EatsOrder o1, EatsOrder o2) {
