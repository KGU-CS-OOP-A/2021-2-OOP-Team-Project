...
public class BaeminOrderManager extends Manager<BaeminOrder> implements OrderService<BaeminOrder> {
	
	@Override
	public void readAll(String filename, Factory<BaeminOrder> factory) {
	...
	public void sortByOrderTime(boolean flag) {
		Comparator<BaeminOrder> comparator = new Comparator<BaeminOrder>() {
			@Override
			public int compare(BaeminOrder o1, BaeminOrder o2) {
